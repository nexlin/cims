...
export default function LeakReclaimsPage() {
  ...
  return (
    <div>
      ...
      <div className="card" style={{ padding: 12, marginBottom: 12, fontSize: 12, color: 'var(--text-muted)' }}>
              ...
              {data.items.map((it, i) => (
                <tr key={i}>
                  ...
                  <td style={{ fontSize: 12 }}>
                    <span style={{ color: it.reason === 'hold_timeout' ? 'var(--danger, #c0392b)' : 'var(--text)' }}>
