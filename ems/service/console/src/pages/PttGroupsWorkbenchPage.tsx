...
function GroupDrawer(p: GroupDrawerProps) {
  ...
  const [form, setForm] = useState<Partial<GroupExt>>(() => existing
    ...
    : { id: '', name: '', priority: 5, encryption: false, emergency_call: false, emergency_alert: true, allow_sds: true, allow_fd: false, max_sds_size: 10000, max_auto_recv: 1048576, video_enabled: false, org_code: '', group_type: 'prearranged', authorized_user_id: null, floor_policy: 'single', max_talkers: 2 })
  // 소유자 표시명 (피커 선택 결과 보존)
