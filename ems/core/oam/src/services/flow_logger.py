...
FLOW_API_DOCS = [
    {'id': 'flow.call-logs', 'module': 'oam-svc', 'method': 'GET', 'path': '/api/v1/call/logs',
     ...
     'params': [
         ...
         {'name': 'hour', 'in': 'query', 'type': 'string', 'required': False, 'desc': 'HH (시간창 한정)'},
    ...
    {'id': 'flow.body', 'module': 'oam-svc', 'method': 'GET', 'path': '/api/v1/flow/body',
     ...
     'params': [
         ...
         {'name': 'sesid', 'in': 'query', 'type': 'string', 'required': False, 'desc': '세션 id (5분 버킷 규칙)'},
    ...
    {'id': 'flow.abnormal-sessions', 'module': 'oam-svc', 'method': 'GET',
     ...
     'response': '{items[], by_reason{}}', 'auth': 'Bearer JWT (monitor)'},
]
