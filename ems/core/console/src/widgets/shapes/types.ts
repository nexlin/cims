...
export type ShapeKind = 'time-bar' | 'series-bar' | 'kpi' | 'stat' | 'distribution' | 'table'
...
export type ShapeData = TimeBarData | SeriesBarData | KpiData | DistributionData | TableData
