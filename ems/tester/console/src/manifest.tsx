  ...
  sections: [
    {
      ...
      routes: [
        ...
        { path: '/test/results',    title: '결과',       component: TesterResultsPage,    requiredRole: 'monitor',
          apis: ['tester.runs', 'tester.run.report', 'tester.run.events', 'tester.run.series', 'tester.run.hist', 'tester.run.sips', 'tester.run.sip', 'tester.run.target_series', 'tester.run.target_alerts', 'tester.run.delete', 'tester.scenario', 'tester.runs.plan'] },
