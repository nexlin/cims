...
**남은 것** = cims-verify S3/S6 나머지 시나리오 항목의 계측기 이전(VoLTE 영상·IBCF 트렁크·FA·PTT 청취 — §9) · 미디어 평면 후속(미디어 전담 워커 분리).
