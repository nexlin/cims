...
**추가할 것**: MCData FD(파일) 의 HTTP 업/다운로드 단계(SDS 의 C-plane ⑪·media plane MSRP ⑪′ 는 구현 반영), RFC 4028 세션 타이머 응답, 신원마다 개별 행동 스크립트(§4).
