...
cims.sh verify phase1 --items P1-PREFLIGHT,P1-START,P1-HEALTH
cims.sh verify phase1 --preset phase1-quick      # preflight + health 만 (가벼운 sanity)
cims.sh verify phase3 --preset phase3-volte      # VoLTE 시나리오만 (5 항목)
