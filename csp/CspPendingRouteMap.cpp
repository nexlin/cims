...
void CCspPendingRouteMap::Insert(const std::string& callId,
                                 const PendingRouteEntry& entry) {
...
bool CCspPendingRouteMap::Take(const std::string& callId,
                               PendingRouteEntry& outEntry) {
