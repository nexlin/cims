...
public:
     ...
     */
    static std::string BuildVoipDir(const std::string& strBaseDir,
                                     ...
                                     const std::string& strCallId)
    {
        ...
        return strBaseDir + "/voip/" + yyyy + "/" + mm + "/" + dd
             + "/" + prefix + "/" + safeCaller
             + "/" + hhmmss + "_" + safeCaller + "_" + safeCallee + "_" + idShort + ".d";
    }
     ...
     * @return 전체 디렉터리 경로
     */
    static std::string BuildPttDir(const std::string& strBaseDir,
                                    const std::string& strCaller,
                                    const std::string& strGroupId)
    {
        ...
        return strBaseDir + "/ptt/" + yyyy + "/" + mm + "/" + dd
             + "/" + prefix + "/" + safeCaller
             + "/" + hhmmss + "_" + safeCaller + ".d";
    }

    /**
     * @brief 메시지 로그 디렉터리 경로 생성
     */
    static std::string BuildMsgLogDir(const std::string& strBaseDir,
                                       const std::string& strCaller,
                                       const std::string& strCallee,
                                       const std::string& strCallId)
    {
...
private:
    static void GetDateTimeParts(std::string& yyyy, std::string& mm,
                                  std::string& dd, std::string& hhmmss)
    {
