...
void StreamInfo::fromPj(const pjsua_stream_info &info)
{
    ...
    if (type == PJMEDIA_TYPE_AUDIO) {
        ...
        cims_print_sockaddr_safe(&info.info.aud.rem_addr, straddr, sizeof(straddr));
        remoteRtpAddress = straddr;
        cims_print_sockaddr_safe(&info.info.aud.rem_rtcp, straddr, sizeof(straddr));
        ...
        cims_print_sockaddr_safe(&info.info.vid.rem_addr, straddr, sizeof(straddr));
        remoteRtpAddress = straddr;
        cims_print_sockaddr_safe(&info.info.vid.rem_rtcp, straddr, sizeof(straddr));
        remoteRtcpAddress = straddr;
        ...
        cims_print_sockaddr_safe(&info.info.txt.rem_addr, straddr, sizeof(straddr));
        remoteRtpAddress = straddr;
        cims_print_sockaddr_safe(&info.info.txt.rem_rtcp, straddr, sizeof(straddr));
        remoteRtcpAddress = straddr;
