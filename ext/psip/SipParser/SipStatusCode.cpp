 ...
 */
const char *SipGetReasonPhrase(int iSipCode) {
  switch (iSipCode) {
  case SIP_TRYING:
    return "Trying";
  case SIP_RINGING:
  ...
  case SIP_GONE:
    return "Gone";
  case SIP_LENGTH_REQUIRED:
    return "Length Required";
  case SIP_CONDITIONAL_REQUEST_FAILED:
    return "Conditional Request Failed";
  case SIP_REQUEST_ENTITY_TOO_LARGE:
    return "Request Entity Too Large";
  case SIP_REQUEST_URI_TOO_LARGE:
  ...
  case SIP_SESSION_INTERVAL_TOO_SMALL:
    return "Session Interval Too Small";
  case SIP_INTERVAL_TOO_BRIEF:
  ...
  case SIP_CONNECT_ERROR:
    return "Connect error";
  case SIP_RING_TIMEOUT_ERROR:
    return "Ring Timeout error";
  }
