 ...
 * @returns SIP 요청 메시지이면 true 를 리턴하고 그렇지 않으면 false 를
 * 리턴한다.
 */
 ...
 * @returns SIP 메소드가 입력한 메소드와 같으면 true 를 리턴하고 그렇지 않으면
 * false 를 리턴한다.
 */
 ...
 * @returns Call-ID 가 동일하면 true 를 리턴하고 그렇지 않으면 false 를
 * 리턴한다.
 */
 ...
 * @param pclsMessage SIP 메시지 저장 객체
 * @returns Call-ID 와 CSeq 의 번호가 동일하면 true 를 리턴하고 그렇지 않으면
 * false 를 리턴한다.
 */
 ...
 * @returns 100rel 헤더를 포함하고 있으면 true 를 리턴하고 그렇지 않으면 false
 * 를 리턴한다.
 */
 ...
 * @returns 성공하면 SIP 응답 메시지 객체의 포인터를 리턴하고 실패하면 NULL 을
 * 리턴한다.
 */
...
/**
 * @ingroup SipParser
 * @brief To 헤더의 tag 가 존재하지 않는 경우 tag 를 생성하여서 저장한 SIP 응답
 * 메시지 객체를 생성한다.
 * @param iStatus SIP 응답 코드
 * @returns 성공하면 SIP 응답 메시지 객체의 포인터를 리턴하고 실패하면 NULL 을
 * 리턴한다.
 ...
 * @param pszName 헤더 이름
 * @returns 헤더 리스트에 존재하면 헤더 객체를 리턴하고 그렇지 않으면 NULL 을
 * 리턴한다.
 */
