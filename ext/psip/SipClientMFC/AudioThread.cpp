...
// 오디오 디바이스를 시작하고 오디오 RTP 포트 생성 및 오디오 RTP 수신 쓰레드를 시작한다.
...
// 오디오 RTP 수신 쓰레드를 종료하고 RTP 포트를 해제한 후, 오디오 디바이스를 중지한다.
...
// PC 마이크에서 녹음된 PCM 음원을 수신 이벤트 callback
