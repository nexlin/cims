...
// SDP attribute 의 value 문자열을 파싱한다.
...
// SDP attribute 의 value 문자열을 저장한다.
...
// 데이터가 존재하면 false 를 리턴하고 그렇지 않으면 true 를 리턴한다.
...
#if 0
// SDP attribute 의 value 를 파싱하여서 clsParamList 객체에 저장한다.
