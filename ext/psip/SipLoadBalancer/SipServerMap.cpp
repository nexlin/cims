...
// 입력된 IP 주소 및 포트 번호가 SIP 서버 정보와 일치하는지 검사한다.
...
// 입력된 IP 주소, 포트번호와 일치하는 SIP 서버 정보가 존재하는지 검사한다.
...
// 입력된 IP 주소, 포트번호와 일치하는 SIP 서버 정보가 존재하면 사용 유무 및 삭제 유무를 업데이트한다.
