...
// Java 에서 생성된 클래스 정보를 저장하고 callback 정보를 저장한다.
bool CAndroidClass::Init( JNIEnv * env )
{
	...
	{
		AndroidErrorLog( "com/esip/SipUserAgent is not found" );
		return false;
	}

	m_jcSipUserAgent = (jclass)env->NewGlobalRef( m_jcSipUserAgent );

	m_jcSipServerInfo = env->FindClass( "com/esip/SipServerInfo" );
	if( m_jcSipServerInfo == NULL )
	{
		AndroidErrorLog( "com/esip/SipServerInfo is not found" );
		return false;
	}

	m_jcSipServerInfo = (jclass)env->NewGlobalRef( m_jcSipServerInfo );

	m_jcSipCallRtp = env->FindClass( "com/esip/SipCallRtp" );
	if( m_jcSipCallRtp == NULL )
	{
		AndroidErrorLog( "com/esip/SipCallRtp is not found" );
		return false;
	}
	...
	m_jmEventIncomingCall = env->GetStaticMethodID( m_jcSipUserAgent, "EventIncomingCall"
		, "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/esip/SipCallRtp;)V" );
	...
	m_jmEventCallRing = env->GetStaticMethodID( m_jcSipUserAgent, "EventCallRing", "(Ljava/lang/String;ILcom/esip/SipCallRtp;)V" );
	...
	m_jmEventCallStart = env->GetStaticMethodID( m_jcSipUserAgent, "EventCallStart", "(Ljava/lang/String;Lcom/esip/SipCallRtp;)V" );
	...
	m_jmEventReInvite = env->GetStaticMethodID( m_jcSipUserAgent, "EventReInvite", "(Ljava/lang/String;Lcom/esip/SipCallRtp;Lcom/esip/SipCallRtp;)V" );
	...
	m_jmEventPrack = env->GetStaticMethodID( m_jcSipUserAgent, "EventPrack", "(Ljava/lang/String;Lcom/esip/SipCallRtp;)V" );
	if( m_jmEventPrack == NULL )
	{
		AndroidErrorLog( "EventPrack is not found" );
		return false;
	}
