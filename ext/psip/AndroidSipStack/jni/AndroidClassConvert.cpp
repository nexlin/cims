...
// Java SipServerInfo 객체를 C++ CSipServerInfo 객체로 복사한다.
...
// C++ CSipServerInfo 객체를 Java SipServerInfo 객체로 복사한다.
...
// Java SipStackSetup 객체를 C++ CSipStackSetup 객체로 복사한다.
...
// Java SipCallRtp 객체를 C++ CSipCallRtp 객체로 복사한다.
...
// C++ CSipCallRtp 객체를 Java SipCallRtp 객체로 복사한다.
