...
CREATE TABLE IF NOT EXISTS volte_subscriptions (
    ...
    forward_no_reply_sec     INT         NOT NULL DEFAULT 0  COMMENT 'CFNR 무응답 시한(초, 0 = Setup.Sip.Cdiv.NoReplySec)',
    forward_not_logged_in_id VARCHAR(64) NOT NULL DEFAULT '' COMMENT 'CFNL 전환 대상(미등록)',
