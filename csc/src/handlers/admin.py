...
CIMS_ADMIN_API_DOCS = [
    {'id': 'csc.users.list', 'module': 'csc', 'method': 'GET', 'path': '/api/v1/users',
     'screens': ['/subscribers/workbench'],
     'summary': '가입자(person) 목록 — VoIP/PTT 번호 포함. 비밀번호는 미포함',
     'params': [], 'response': '{users[]}', 'auth': 'Bearer JWT (monitor)'},
    {'id': 'csc.users.create', 'module': 'csc', 'method': 'POST', 'path': '/api/v1/users',
     'screens': ['/subscribers/workbench'],
     'summary': '가입자 생성',
     'params': [{'name': 'body', 'in': 'body', 'type': 'object', 'required': True,
                 'desc': '{name, org_id, title?, email?, login_id?, passwd?, reject_id?}'}],
    ...
    {'id': 'csc.users.get', 'module': 'csc', 'method': 'GET', 'path': '/api/v1/users/{person_id}',
     ...
     'response': '가입자 객체', 'auth': 'Bearer JWT (monitor)'},
    ...
    {'id': 'csc.users.subs.list', 'module': 'csc', 'method': 'GET',
     ...
     'response': '{subscriptions[]}', 'auth': 'Bearer JWT (monitor)'},
    {'id': 'csc.users.subs.add', 'module': 'csc', 'method': 'POST',
     ...
     'params': [
         ...
         {'name': 'body', 'in': 'body', 'type': 'object', 'required': True,
          'desc': '{id(MSISDN), imsi, service_ref?, dnd?, forward_id?}'},
     ],
     'response': '{id}', 'auth': 'Bearer JWT (manager)'},
    ...
    {'id': 'csc.ptt-groups.list', 'module': 'csc', 'method': 'GET', 'path': '/api/v1/ptt/groups',
     'screens': ['/subscribers/ptt-groups'],
     'summary': 'PTT 그룹 목록 (id = mcptt_group_id)',
     'params': [], 'response': '{groups[]}', 'auth': 'Bearer JWT (monitor)'},
    {'id': 'csc.ptt-groups.create', 'module': 'csc', 'method': 'POST', 'path': '/api/v1/ptt/groups',
     'screens': ['/subscribers/ptt-groups'],
     'summary': 'PTT 그룹 생성',
     'params': [{'name': 'body', 'in': 'body', 'type': 'object', 'required': True,
                 'desc': '{mcptt_group_id, name, org_id, ...}'}],
     'response': '{id}', 'auth': 'Bearer JWT (operator)'},
    {'id': 'csc.ptt-groups.get', 'module': 'csc', 'method': 'GET', 'path': '/api/v1/ptt/groups/{group_id}',
     ...
     'response': '그룹 객체', 'auth': 'Bearer JWT (monitor)'},
    {'id': 'csc.ptt-groups.update', 'module': 'csc', 'method': 'PUT', 'path': '/api/v1/ptt/groups/{group_id}',
     'screens': ['/subscribers/ptt-groups'],
     ...
     'response': '{id}', 'auth': 'Bearer JWT (operator, 소유자 검사)'},
    ...
    {'id': 'csc.ptt-groups.members.list', 'module': 'csc', 'method': 'GET',
     ...
     'summary': '그룹 구성원 목록',
     'params': [{'name': 'group_id', 'in': 'path', 'type': 'string', 'required': True, 'desc': 'MCPTT 그룹 ID'}],
     'response': '{group_id, members[]}', 'auth': 'Bearer JWT (monitor)'},
    {'id': 'csc.ptt-groups.members.add', 'module': 'csc', 'method': 'POST',
     ...
     'params': [
         {'name': 'group_id', 'in': 'path', 'type': 'string', 'required': True, 'desc': 'MCPTT 그룹 ID'},
         {'name': 'body', 'in': 'body', 'type': 'object', 'required': True,
          'desc': '{user_id(MSISDN), role?, priority?}'},
     ],
     'response': '{group_id, user_id}', 'auth': 'Bearer JWT (operator, 소유자 검사)'},
