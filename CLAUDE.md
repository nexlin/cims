...
- [sip_tls_signaling.md](docs/design/features/sip_tls_signaling.md) — SIP TLS 시그널링 (transport 별 도달 모델 = 목적지 주소 vs 연결 열쇠, latch 갱신 규율 일반화, 서버/단말 구현 상태·전환 계획 — 설계 정본, 구현 착수 전)
